...
class Tile {
    ...
    public string $location; // deck (bag), factory, center, hand${playerId}, wall${playerId}, discard
    public int $star; // factory : unused, else star
    public int $space; // factory : 0 for center 1-9 for factories, 1-10 for center, else space in star
