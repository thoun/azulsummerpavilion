 ...
 * -----
 *
 * azulsummerpavilion.js
 *
 * AzulSummerPavilion user interface script
 * 
...
function (dojo, declare) {
    return declare("bgagame.azulsummerpavilion", ebg.core.gamegui, {
        constructor: function(){
            console.log('azulsummerpavilion constructor');
